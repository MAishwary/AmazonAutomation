...
public class iphonePriceDisplay 
{
	public static void main(String[] args) 
	{
		...
		{			
			...
			dc.setCapability(MobileCapabilityType.AUTOMATION_NAME,"UiAutomator2");  //UiAutomator2 emulator-5554
			dc.setCapability(MobileCapabilityType.PLATFORM_NAME,"Android");
			dc.setCapability(MobileCapabilityType.PLATFORM_VERSION,"7.1.1");
			dc.setCapability(MobileCapabilityType.DEVICE_NAME,"Nexus 6 API 25");
